...
Updated on 2024-11-29 17:32:44.042280
'''
from collections import namedtuple
Exchange = namedtuple("Exchange", ["id", "name", "country_set", "country_code_set", "region_set", "product_types_set"])

AEB = Exchange(id="AEB", name="Amsterdamse Effectenbeurs", country_set={'Netherlands'}, country_code_set={'NL'}, region_set={'Europe'}, product_types_set={'Structured Products', 'Stocks', 'Indices'})
...
AMEX = Exchange(id="AMEX", name="American Stock Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Options', 'Indices', 'Warrants'})
APEXEN = Exchange(id="APEXEN", name="Apex - Euronext", country_set={'France', 'Portugal', 'Netherlands', 'Belgium'}, country_code_set={'BE', 'PT', 'FR', 'NL'}, region_set={'Europe'}, product_types_set={'Stocks'})
...
AQEUEN = Exchange(id="AQEUEN", name="Aquis Exchange Europe - Euronext", country_set={'France', 'Portugal', 'Netherlands', 'Belgium'}, country_code_set={'BE', 'PT', 'FR', 'NL'}, region_set={'Europe'}, product_types_set={'Stocks'})
...
ARCA = Exchange(id="ARCA", name="Archipelago", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Indices', 'Warrants'})
...
BATEEN = Exchange(id="BATEEN", name="Cboe Europe Ltd. - BXE Order Book - Euronext", country_set={'France', 'Portugal', 'Netherlands', 'Belgium'}, country_code_set={'BE', 'PT', 'FR', 'NL'}, region_set={'Europe'}, product_types_set={'Stocks'})
...
BATS = Exchange(id="BATS", name="BATS Trading Inc", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Options', 'Indices', 'Warrants'})
BELFOX = Exchange(id="BELFOX", name="Belgian Futures & Options Exchange", country_set={'Belgium'}, country_code_set={'BE'}, region_set={'Europe'}, product_types_set={'Futures', 'Options', 'Indices'})
...
BM = Exchange(id="BM", name="Bolsa de Madrid", country_set={'Spain'}, country_code_set={'ES'}, region_set={'Europe'}, product_types_set={'Stocks', 'Indices'})
...
BVL = Exchange(id="BVL", name="Lisbon Stock Exchange", country_set={'Portugal'}, country_code_set={'PT'}, region_set={'Europe'}, product_types_set={'Stocks', 'Indices'})
BVME = Exchange(id="BVME", name="Borsa Valori di Milano", country_set={'Italy'}, country_code_set={'IT'}, region_set={'Europe'}, product_types_set={'Stocks', 'Indices', 'Warrants'})
...
CBOE = Exchange(id="CBOE", name="Chicago Board Options Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Options', 'Indices'})
CBOE2 = Exchange(id="CBOE2", name="Chicago Board Options Exchange 2", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options', 'Indices'})
CBOT = Exchange(id="CBOT", name="Chicago Board of Trade", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
CDE = Exchange(id="CDE", name="Canadian Derivatives Exchange (Bourse de Montreal)", country_set={'Canada'}, country_code_set={'CA'}, region_set={'Americas'}, product_types_set={'Options on Futures', 'Futures', 'Options', 'Indices'})
CEDX = Exchange(id="CEDX", name="CBOE Europe Derivatives", country_set={'Netherlands'}, country_code_set={'NL'}, region_set={'Europe'}, product_types_set={'Structured Products', 'Indices', 'Metals'})
CFE = Exchange(id="CFE", name="CBOE Futures Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
...
CHIXEN = Exchange(id="CHIXEN", name="Cboe Europe Ltd. - CXE Order Book - Clearnet", country_set={'France', 'Portugal', 'Netherlands', 'Belgium'}, country_code_set={'BE', 'PT', 'FR', 'NL'}, region_set={'Europe'}, product_types_set={'Stocks'})
...
CME = Exchange(id="CME", name="Chicago Mercantile Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
COMEX = Exchange(id="COMEX", name="Commodity Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
...
DXEEN = Exchange(id="DXEEN", name="Cboe Europe B.V. - DXE Order Book - Euronext", country_set={'France', 'Portugal', 'Netherlands', 'Belgium'}, country_code_set={'BE', 'PT', 'FR', 'NL'}, region_set={'Europe'}, product_types_set={'Stocks'})
...
EBS = Exchange(id="EBS", name="Elektronische Boerse Schweiz", country_set={'Switzerland'}, country_code_set={'CH'}, region_set={'Europe'}, product_types_set={'Structured Products', 'Warrants', 'Stocks', 'Bonds', 'Indices'})
...
EDGX = Exchange(id="EDGX", name="BATS Trading EDGX", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Options', 'Indices'})
...
ENDEX = Exchange(id="ENDEX", name="ICE Endex Futures", country_set={'Netherlands'}, country_code_set={'NL'}, region_set={'Europe'}, product_types_set={'Futures', 'Indices'})
ENEXT_BE = Exchange(id="ENEXT.BE", name="Euronext Belgium", country_set={'Belgium'}, country_code_set={'BE'}, region_set={'Europe'}, product_types_set={'Structured Products', 'Stocks'})
EUREX = Exchange(id="EUREX", name="EUREX", country_set={'Germany'}, country_code_set={'DE'}, region_set={'Europe'}, product_types_set={'Options on Futures', 'Futures', 'Options', 'Indices'})
...
EURONEXT = Exchange(id="EURONEXT", name="Euronext Regulated Bond Market", country_set={'France'}, country_code_set={'FR'}, region_set={'Europe'}, product_types_set={'Bonds', 'Mutual Funds'})
FTA = Exchange(id="FTA", name="Financiele Termijnmarkt Amsterdam", country_set={'Netherlands'}, country_code_set={'NL'}, region_set={'Europe'}, product_types_set={'Futures', 'Options', 'Indices'})
...
FWB = Exchange(id="FWB", name="Frankfurter Wertpapierboerse", country_set={'Germany'}, country_code_set={'DE'}, region_set={'Europe'}, product_types_set={'Structured Products', 'Stocks', 'Warrants'})
...
GETTEX = Exchange(id="GETTEX", name="B��rse M��nchen AG", country_set={'Germany'}, country_code_set={'DE'}, region_set={'Europe'}, product_types_set={'Structured Products', 'Stocks', 'Warrants'})
...
IBIS = Exchange(id="IBIS", name="Integriertes Boersenhandels- und Informations-System", country_set={'Germany'}, country_code_set={'DE'}, region_set={'Europe'}, product_types_set={'Stocks', 'Indices'})
...
ICEEU = Exchange(id="ICEEU", name="ICE Futures Europe", country_set={'United Kingdom'}, country_code_set={'GB'}, region_set={'Europe'}, product_types_set={'Options on Futures', 'Futures', 'Options', 'Indices'})
ICEEUSOFT = Exchange(id="ICEEUSOFT", name="ICE Europe Soft Commodities", country_set={'United Kingdom'}, country_code_set={'GB'}, region_set={'Europe'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
...
IDEM = Exchange(id="IDEM", name="Italian Derivatives Market Milano", country_set={'Italy'}, country_code_set={'IT'}, region_set={'Europe'}, product_types_set={'Futures', 'Options', 'Indices'})
...
IPE = Exchange(id="IPE", name="International Petroleum Exchange", country_set={'United Kingdom'}, country_code_set={'GB'}, region_set={'Europe'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
ISE = Exchange(id="ISE", name="International Securities Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Options', 'Indices', 'Warrants'})
...
LSE = Exchange(id="LSE", name="London Stock Exchange", country_set={'United Kingdom'}, country_code_set={'GB'}, region_set={'Europe'}, product_types_set={'Stocks', 'Indices'})
...
MATIF = Exchange(id="MATIF", name="Marche A Terme d'Instruments Financiers", country_set={'France'}, country_code_set={'FR'}, region_set={'Europe'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
MEFFRV = Exchange(id="MEFFRV", name="Mercado Espanol de Futuros Financieros Renta Variable PROXY", country_set={'Spain'}, country_code_set={'ES'}, region_set={'Europe'}, product_types_set={'Futures', 'Options', 'Indices'})
MEMX = Exchange(id="MEMX", name="Members Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Options', 'Warrants'})
...
MEXDER = Exchange(id="MEXDER", name="Mercado Mexicano de Derivados", country_set={'Mexico'}, country_code_set={'MX'}, region_set={'Americas'}, product_types_set={'Futures', 'Options', 'Options on Futures'})
...
MONEP = Exchange(id="MONEP", name="Marche des Opts Neg. de la Bourse de Paris", country_set={'France'}, country_code_set={'FR'}, region_set={'Europe'}, product_types_set={'Futures', 'Options', 'Indices'})
...
NASDAQ = Exchange(id="NASDAQ", name="National Association of Security Dealers", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Indices', 'Warrants'})
...
NYBOT = Exchange(id="NYBOT", name="New York Board of Trade", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
NYMEX = Exchange(id="NYMEX", name="New York Mercantile Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
NYSE = Exchange(id="NYSE", name="New York Stock Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Bonds', 'Indices', 'Warrants'})
...
NYSELIFFE = Exchange(id="NYSELIFFE", name="NYSE Liffe US", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options on Futures', 'Futures', 'Indices'})
...
OMS = Exchange(id="OMS", name="Stockholm Options Market", country_set={'Sweden'}, country_code_set={'SE'}, region_set={'Europe'}, product_types_set={'Futures', 'Options', 'Indices'})
...
OSE = Exchange(id="OSE", name="Oslo Stock Exchange", country_set={'Norway'}, country_code_set={'NO'}, region_set={'Europe'}, product_types_set={'Stocks', 'Indices'})
...
PEARL = Exchange(id="PEARL", name="MIAX PEARL Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Options', 'Warrants'})
PHLX = Exchange(id="PHLX", name="Philadelphia Stock Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Stocks', 'Options', 'Indices'})
...
PSE = Exchange(id="PSE", name="Pacific Stock Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Options', 'Indices'})
...
SBF = Exchange(id="SBF", name="Society des Bourses Francaises", country_set={'France'}, country_code_set={'FR'}, region_set={'Europe'}, product_types_set={'Structured Products', 'Stocks', 'Indices', 'Warrants'})
SFB = Exchange(id="SFB", name="Stockholm FondBors", country_set={'Sweden'}, country_code_set={'SE'}, region_set={'Europe'}, product_types_set={'Stocks', 'Indices'})
...
SMFE = Exchange(id="SMFE", name="The Small Exchange", country_set={'United States'}, country_code_set={'US'}, region_set={'Americas'}, product_types_set={'Futures', 'Options on Futures'})
SWB = Exchange(id="SWB", name="Stuttgart Wertpapierboerse", country_set={'Germany'}, country_code_set={'DE'}, region_set={'Europe'}, product_types_set={'Structured Products', 'Stocks', 'Warrants'})
...
TGHEEN = Exchange(id="TGHEEN", name="Turquoise Global Holdings Europe B.V. - Euronext", country_set={'France', 'Portugal', 'Netherlands', 'Belgium'}, country_code_set={'BE', 'PT', 'FR', 'NL'}, region_set={'Europe'}, product_types_set={'Stocks'})
...
TRQXEN = Exchange(id="TRQXEN", name="Turquoise Europe EN", country_set={'France', 'Portugal', 'Netherlands', 'Belgium'}, country_code_set={'BE', 'PT', 'FR', 'NL'}, region_set={'Europe'}, product_types_set={'Stocks'})
...
TSE = Exchange(id="TSE", name="Toronto Stock Exchange", country_set={'Canada'}, country_code_set={'CA'}, region_set={'Americas'}, product_types_set={'Stocks', 'Indices', 'Warrants'})
...
VSE = Exchange(id="VSE", name="Vienna Stock Exchange", country_set={'Austria'}, country_code_set={'AT'}, region_set={'Europe'}, product_types_set={'Stocks', 'Indices'})
